...
# Patch 5: HYBRID DISPATCH — fused for prefill (T>1), autoregressive for generation (T=1)
COPY patch_hybrid_dispatch.py /tmp/patch_hybrid_dispatch.py
RUN python3 /tmp/patch_hybrid_dispatch.py
