...
# Patch 5: Force n_tasks=1 for DELTA_NET (race condition workaround) + aliasing diagnostic
COPY patch_ntasks1.py /tmp/patch_ntasks1.py
RUN python3 /tmp/patch_ntasks1.py
