...
# Patch 5: Force single-threaded delta_net kernel (race condition workaround)
COPY patch_single_thread_kernel.py /tmp/patch_single_thread_kernel.py
RUN python3 /tmp/patch_single_thread_kernel.py
